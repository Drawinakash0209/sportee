...
<div class="mt-12 antialiased mx-auto max-w-screen-sm">
    ...
    @forelse($indoors->comments as $comment)
        ...
        <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column m-10">
            ...
            <div class="mt-5 flex items-start gap-4">
                ...
                <div class="text-xs">
                    <cite class="not-italic">User</cite>
                </div>
            </div>
        </blockquote>
    ...
    <div class="flex mx-auto items-center justify-center shadow-lg mt-16 mx-8 mb-4 max-w-lg">
            ...
            <form action="{{ url('comments') }}" method="post" class="w-full max-w-xl bg-white rounded-lg px-4 pt-2">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-full px-3 mb-2 mt-2">
                        <textarea name="comments" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white" placeholder='Type Your Comment' required></textarea>
                    </div>
        ...
        @else
            <p class="text-gray-500">Please <a href="{{ route('login') }}" class="text-blue-500 underline">log in</a> to comment.</p>
        @endauth
    </div>
</div>
